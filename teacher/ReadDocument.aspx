<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ReadDocument.aspx.cs" Inherits="teacher_ReadDocument" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="document">
        <h2><%=document.Name %></h2>
        <%if (document.Author==Session["name"].ToString()){ %>
        <span class="documentInfo">此篇技术资料是你所编写，你可以： </span>
        <asp:Button ID="Button1" runat="server" Text="编辑" CssClass="documentButton" OnClick="Button1_Click" />
        <asp:Button ID="Button2" runat="server" Text="删除" CssClass="documentButton" OnClick="Button2_Click" />
        <br /><br />
        <%} %>
