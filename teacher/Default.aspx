<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="teacher_Default" %>
...
<asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="DataClassesDataContext" EntityTypeName="" Select="new (Course, Teacher)" TableName="Table_Course_Setup" Where="Teacher == @Teacher">
    <WhereParameters>
        <asp:SessionParameter DefaultValue="" Name="Teacher" SessionField="name" Type="String" />
    </WhereParameters>
</asp:LinqDataSource>
