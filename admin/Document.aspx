...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ContentTemplate>  
    <asp:LinqDataSource ID="LinqDataSource1" EnableDelete="true" EnableViewState="false" runat="server" ContextTypeName="DataClassesDataContext" EntityTypeName="" TableName="Table_Document">
    </asp:LinqDataSource>
